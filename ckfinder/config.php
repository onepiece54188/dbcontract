...
$myfile = fopen("D:/git_projects/dbcontract/ckfinder/ckfinderbaseUrl.txt", "r") or die("Unable to open file!");
$baseUrl = fread($myfile,filesize("D:/git_projects/dbcontract/ckfinder/ckfinderbaseUrl.txt"));
fclose($myfile);
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/ckfinder/'.$baseUrl.'/',
